...
export const shadowmancy = {
  ...
  shadowStrikeFail: new SkillDefinition({
    id: "shadowStrikeFail",
    fullName: "Shadow Strike",
    firstPerson: /^(?<target>.+?) is not surrounded by a magical shield\.$/,
    secondPerson: false,
    thirdPerson: false,
    profession: ["depthswalker"],
    skill: "shadowmancy",
  ...
  shadowStrike: new SkillDefinition({
    id: "shadowStrike",
    fullName: "Shadow Strike",
  ...
  shadowStrikeKneel: new SkillDefinition({
  ...
  degeneration: new SkillDefinition({
    id: "degeneration",
  ...
  degenerationFull: new SkillDefinition({
    id: "degenerationFull",
    fullName: "Degeneration",
  ...
  depression: new SkillDefinition({
    id: "depression",
    fullName: "Depression",
    secondPerson:
  ...
  depressionFull: new SkillDefinition({
    id: "depressionFull",
    fullName: "Depression",
    secondPerson:
  ...
  retribution: new SkillDefinition({
    id: "retribution",
  ...
  retributionFull: new SkillDefinition({
    id: "retributionFull",
    fullName: "Retribution",
    secondPerson:
  ...
  madnessFull: new SkillDefinition({
    id: "madnessFull",
    fullName: "Madness",
    secondPerson:
