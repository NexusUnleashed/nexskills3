...
export const psionics = {
  splinterHit: new SkillDefinition({
    id: "splinterHit",
    fullName: "Splinter",
    firstPerson:
  ...
  splinterMiss: new SkillDefinition({
    id: "splinterMiss",
    fullName: "Splinter",
    firstPerson:
  ...
  combustion: new SkillDefinition({
    id: "combustion",
    fullName: "Combustion",
    firstPerson:
  ...
  combustionMiss: new SkillDefinition({
    id: "combustionMiss",
    fullName: "Combustion",
    firstPerson:
  ...
  breakthrough: new SkillDefinition({
    id: "breakthrough",
