const bladedance = {
    ...
    bladedancePunctuate: {
      ...
      secondPerson: /^(?<user>\w+) strikes only air with \w+ flurry of blows, the tip of \w+ rapier flickering before your face\.$/, 
      thirdPerson: false,
      profession: ["bard"],
      skill: "bladedance",
      balance: "balance",
...
const composition = {
  compositionRefrainpaean: {
      ...
      firstPerson: /^Your paean slams into (?<target>\w+) with all the weight of history's greatest triumphs\.$/,  
      //Dzak's paean slams into you with all the weight of history's greatest triumphs. 
      secondPerson: /^(?<user>.+?) paean slams into you with all the weight of history's greatest triumphs\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
  ...
  compositionRefrainbhajan:  {
      ...
      firstPerson: /^The sinister implications of your refrain plague (?<target>\w+)\.$/,  
      //The sinister implications of Dzak's refrain plague you.
      secondPerson: /^The sinister implications of (?<user>.+?) refrain plague you\.$/,   
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: false, // refrains hit separately and simultaneously (technically before) blade attacks. Thus they don't consume a balance but simply accompany the blade attack balance.
  ...
  compositionRefrainnomoshit:  {
      ...
      secondPerson: /^The nomos of (?<user>.+?) sings out as it shatters the anti-weapon field surrounding you.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: false, // refrains hit separately and simultaneously (technically before) blade attacks. Thus they don't consume a balance but simply accompany the blade attack balance.
  ...
  compositionRefrainnomosmiss:  {
      ...
      secondPerson: /^The nomos of (?<user>.+?) wails discordantly as it finds nothing surrounding you to destroy\.$/,   
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: false, // refrains hit separately and simultaneously (technically before) blade attacks. Thus they don't consume a balance but simply accompany the blade attack balance.
  ...
  compositionRefraingusheh: {
      ...
      firstPerson: /^Your refrain brings on an unending appetite in (?<target>\w+)\.$/,  
      //Dzak's gusheh brings on an unending appetite in you.
      secondPerson: /^(?<user>.+?) gusheh brings on an unending appetite in you\.$/,   
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: false, // refrains hit separately and simultaneously (technically before) blade attacks. Thus they don't consume a balance but simply accompany the blade attack balance.
  ...
  compositionRefrainelegy: {
      ...
      secondPerson: /^The great losses of your life weigh heavy upon your soul with (?<user>.+?) elegy for the departed\.$/,   
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: false, // refrains hit separately and simultaneously (technically before) blade attacks. Thus they don't consume a balance but simply accompany the blade attack balance.
  ...
  compositionRefrainprosodion: {
      ...
      firstPerson: /^You call forth the nobility of the Elder Days in your prosodion\.$/,  
      //The nobility of Dzak's prosodion brings misfortune unto you.
      secondPerson: /^The nobility of (?<user>.+?) prosodion brings misfortune unto you\.$/,   
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: false, // refrains hit separately and simultaneously (technically before) blade attacks. Thus they don't consume a balance but simply accompany the blade attack balance.
...
compositionPaean: {
      ...
      firstPerson: /^You raise .+ and channel avenging hostility into a rousing paean\.$/,  
      //Dzak raises a bard's mandolin and channels avenging hostility into a rousing paean.
      secondPerson: /^(?<user>.+?) raises .+ and channels avenging hostility into a rousing paean\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium",
  ...
  compositionBhajan: {
      ...
      firstPerson: /^With frantic motions, you bring forth the dark, foreboding curse of a bhajan\.$/,   
      //With frantic motions, Dzak brings forth the dark, foreboding curse of a bhajan.
      secondPerson: /^With frantic motions, (?<user>.+?) brings forth the dark, foreboding curse of a bhajan\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium",
  ...
  compositionNomos: {
      ...
      firstPerson: /^You still your racing heart and steady your shaking hands to play your nomos with unbreaking discipline and control\.$/,   
      //Dzak begins to play a famous nomos with unbreaking discipline and control.
      secondPerson: /^(?<user>.+?) begins to play a famous nomos with unbreaking discipline and control\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium", 
  ...
  compositionGusheh: {
      ...
      firstPerson: /^The sweeping, upbeat music of a gusheh flows unending from your instrument like wine from an amphora\.$/,   
      //The sweeping, upbeat music of a gusheh flows unending from Dzak's instrument like wine from an amphora.
      secondPerson: /^The sweeping, upbeat music of a gusheh flows unending from (?<user>.+?) instrument like wine from an amphora\.$/, 
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium", 
  ...
  compositionOde: {
      ...
      firstPerson: /^With a heart full of music and your .+, you bring forth the memories of the greatest heroes of Sapience\.$/,   
      //With reverent mien, Dzak brings forth the memories of the greatest heroes of Sapience.
      secondPerson: /^With reverent mien, (?<user>.+?) brings forth the memories of the greatest heroes of Sapience\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium", 
  ...
  compositionGhazal: {
      ...
      firstPerson: /^With hooded eyes, you take up your .+ and breathe the spirit of love into the world around you\.$/,  
      //With hooded eyes, Dzak takes up a bard's mandolin and breathes the spirit of love into the world around you.
      secondPerson: /^With hooded eyes, (?<user>.+?) takes up .+ and breathes the spirit of love into the world around you\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium", 
  ...
  compositionElegy: {
      ...
      firstPerson: /^You steady your nerves and bring forth a noble elegy with .+, honouring the memory of those who came before\.$/,  
      //Dzak brings forth a noble elegy upon a bard's mandolin, honouring the memory of those who came before.
      secondPerson: /^(?<user>.+?) brings forth a noble elegy upon .+, honouring the memory of those who came before\.$/,  
      thirdPerson: false,
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium", 
  ...
  compositionProsodion: {
      ...
      firstPerson: /^You play your .+ with a heart full of worship, dutifully offering your music for the glory of the Gods\.$/,  
      //Dzak plays his a bard's mandolin to dutifully offer his music for the glory of the Gods.
      thirdPerson: false,
      secondPerson: /^(?<user>.+?) plays .+ to dutifully offer \w+ music for the glory of the Gods.$/,  
      profession: ["bard"],
      skill: "composition",
      balance: "equilibrium", 
      multiLine: 0,
...
//Passive movement heals and misc.
  ...
  const bardrage = {
    bardrageMoulinet: {
        id: "moulinet",
        fullName: "Moulinet",
        //You twist your wrist swiftly, slicing a grizzly bear with a long slash of your sweeping blade.
        firstPerson: /^You twist your wrist swiftly, slicing (?<target>\w+) with a long slash of your sweeping blade\.$/,   
        secondPerson: ,  
        thirdPerson: false,
        profession: ["bard"],
        skill: "composition",
      ...
      bardrageTrill: {
        id: "trill",
        fullName: "Trill",
         //You direct your voice in a high-pitched trill at a grizzly bear, dazing him.
        firstPerson: /^You direct your voice in a high-pitched trill at (?<target>\w+), dazing \w+\.$/,   
        secondPerson: ,  
        thirdPerson: false,
        profession: ["bard"],
        skill: "composition",
      ...
      bardrageHowlslash: {
        id: "howlslash",
        fullName: "Howlslash",
         //You use your powerful voice to distract a black bear with a ululating howl before stepping in with a vicious slash.
        firstPerson: /^You use your powerful voice to distract (?<target>\w+) with a ululating howl before stepping in with a vicious slash\.$/,   
        secondPerson: ,  
        thirdPerson: false,
        profession: ["bard"],
        skill: "composition",
