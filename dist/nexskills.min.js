...
!(function () {
  ...
  for (
    var byteLength_1 = function byteLength(b64) {
        var lens = getLens(b64),
          validLen = lens[0],
          placeHoldersLen = lens[1];
        return (3 * (validLen + placeHoldersLen)) / 4 - placeHoldersLen;
      },
      toByteArray_1 = function toByteArray(b64) {
        var tmp,
          i,
          lens = getLens(b64),
          validLen = lens[0],
      ...
      fromByteArray_1 = function fromByteArray(uint8) {
        for (
          var tmp,
            len = uint8.length,
            extraBytes = len % 3,
  ...
  var base64Js = {
    ...
    ieee754_read = function read(buffer, offset, isLE, mLen, nBytes) {
      var e,
        m,
    ...
    ieee754_write = function write(buffer, value, offset, isLE, mLen, nBytes) {
      var e,
        m,
        c,
        eLen = 8 * nBytes - mLen - 1,
    ...
    buffer$1 = (function createCommonjsModule(fn, module) {
      ...
      function slowToString(encoding, start, end) {
        var loweredCase = !1;
        if (
          ((void 0 === start || start < 0) && (start = 0), start > this.length)
        )
          return "";
        if (
      ...
      function base64Slice(buf, start, end) {
        return 0 === start && end === buf.length
          ? base64Js.fromByteArray(buf)
          : base64Js.fromByteArray(buf.slice(start, end));
      }
      ...
      function writeFloat(buf, value, offset, littleEndian, noAssert) {
        return (
          ...
          ieee754_write(buf, value, offset, littleEndian, 23, 4),
          offset + 4
        );
      }
      function writeDouble(buf, value, offset, littleEndian, noAssert) {
        return (
          ...
          ieee754_write(buf, value, offset, littleEndian, 52, 8),
          offset + 8
        );
      }
      (Buffer.prototype.slice = function slice(start, end) {
        ...
        (Buffer.prototype.readFloatLE = function readFloatLE(offset, noAssert) {
          return (
            (offset >>>= 0),
            noAssert || checkOffset(offset, 4, this.length),
            ieee754_read(this, offset, !0, 23, 4)
          );
        }),
        (Buffer.prototype.readFloatBE = function readFloatBE(offset, noAssert) {
          return (
            (offset >>>= 0),
            noAssert || checkOffset(offset, 4, this.length),
            ieee754_read(this, offset, !1, 23, 4)
          );
        }),
        (Buffer.prototype.readDoubleLE = function readDoubleLE(
          ...
          return (
            ...
            ieee754_read(this, offset, !0, 52, 8)
          );
        }),
        (Buffer.prototype.readDoubleBE = function readDoubleBE(
          ...
          return (
            (offset >>>= 0),
            noAssert || checkOffset(offset, 8, this.length),
            ieee754_read(this, offset, !1, 52, 8)
          );
        }),
  ...
  buffer$1.SlowBuffer, buffer$1.INSPECT_MAX_BYTES, buffer$1.kMaxLength;
  ...
  var BSONError = (function (_super) {
      function BSONError(message) {
        ...
        return Object.setPrototypeOf(_this, BSONError.prototype), _this;
      }
      return (
    ...
    BSONTypeError = (function (_super) {
      function BSONTypeError(message) {
        var _this = _super.call(this, message) || this;
        return Object.setPrototypeOf(_this, BSONTypeError.prototype), _this;
      }
      return (
  ...
  function getGlobal() {
    return (
      checkForMath("object" == typeof globalThis && globalThis) ||
      checkForMath("object" == typeof window && window) ||
      checkForMath("object" == typeof self && self) ||
      checkForMath(
  ...
  var insecureRandomBytes = function insecureRandomBytes(size) {
      var insecureWarning = (function isReactNative() {
        var g = getGlobal();
        return (
          "object" == typeof g.navigator &&
          "ReactNative" === g.navigator.product
        );
      })()
        ? "BSON: For React Native please polyfill crypto.getRandomValues, e.g. using: https://www.npmjs.com/package/react-native-get-random-values."
        : "BSON: No cryptographic implementation for random bytes present, falling back to a less secure implementation.";
      console.warn(insecureWarning);
      for (var result = buffer_1.alloc(size), i = 0; i < size; ++i)
    ...
    randomBytes = (function () {
      ...
      return void 0 !== __webpack_require__.g &&
        ...
        ? function (size) {
            return __webpack_require__.g.crypto.getRandomValues(
              buffer_1.alloc(size)
            );
          }
        : insecureRandomBytes;
  ...
  function isUint8Array(value) {
    return "[object Uint8Array]" === Object.prototype.toString.call(value);
  }
  function isRegExp(d) {
    return "[object RegExp]" === Object.prototype.toString.call(d);
  }
  function isDate(d) {
    return (
      isObjectLike(d) && "[object Date]" === Object.prototype.toString.call(d)
    );
  }
  ...
  function deprecate(fn, message) {
    ...
    return function deprecated() {
      ...
      return (
        warned || (console.warn(message), (warned = !0)), fn.apply(this, args)
      );
    };
  }
  ...
  var VALIDATION_REGEX =
    ...
    uuidValidateString = function (str) {
      return "string" == typeof str && VALIDATION_REGEX.test(str);
    },
    ...
    bufferToUuidHexString = function (buffer, includeDashes) {
      return (
        void 0 === includeDashes && (includeDashes = !0),
        includeDashes
    ...
    JS_INT_MAX = (Math.pow(2, 63), Math.pow(2, 63), Math.pow(2, 53)),
    ...
    Binary = (function () {
      function Binary(buffer, subType) {
        ...
        (this.sub_type =
          null != subType ? subType : Binary.BSON_BINARY_SUBTYPE_DEFAULT),
          null == buffer
      ...
      return (
        (Binary.prototype.put = function (byteValue) {
          if ("string" == typeof byteValue && 1 !== byteValue.length)
            throw new BSONTypeError("only accepts single character String");
          if ("number" != typeof byteValue && 1 !== byteValue.length)
            throw new BSONTypeError(
          ...
          if (
            (decodedByte =
              "string" == typeof byteValue
                ? byteValue.charCodeAt(0)
                : "number" == typeof byteValue
                ? byteValue
                : byteValue[0]) < 0 ||
            decodedByte > 255
          )
        ...
        (Binary.prototype.read = function (position, length) {
          return (
            ...
            this.buffer.slice(position, position + length)
          );
        }),
        (Binary.prototype.value = function (asRaw) {
          return (asRaw = !!asRaw) && this.buffer.length === this.position
            ? this.buffer
            : asRaw
        ...
        (Binary.prototype.toExtendedJSON = function (options) {
          ...
          var base64String = this.buffer.toString("base64"),
            subType = Number(this.sub_type).toString(16);
          return options.legacy
            ? {
                $binary: base64String,
                $type: 1 === subType.length ? "0" + subType : subType,
              }
            : {
                $binary: {
                  base64: base64String,
                  subType: 1 === subType.length ? "0" + subType : subType,
                },
              };
        }),
        (Binary.prototype.toUUID = function () {
          ...
          throw new BSONError(
            'Binary sub_type "'
              ...
              .concat(Binary.SUBTYPE_UUID, '" is currently supported.')
          );
        }),
        (Binary.fromExtendedJSON = function (doc, options) {
          ...
          if (
            ...
            "$binary" in doc
              ...
              : "$uuid" in doc &&
                ((type = 4), (data = uuidHexStringToBuffer(doc.$uuid))),
            !data)
          )
            throw new BSONTypeError(
          ...
          return 4 === type ? new UUID(data) : new Binary(data, type);
        }),
        (Binary.prototype[Symbol.for("nodejs.util.inspect.custom")] =
          function () {
            return this.inspect();
          }),
        (Binary.prototype.inspect = function () {
          var asBuffer = this.value(!0);
          return 'new Binary(Buffer.from("'
            .concat(asBuffer.toString("hex"), '", "hex"), ')
  ...
  var UUID = (function (_super) {
      function UUID(input) {
        var bytes,
          hexStr,
          _this = this;
        if (null == input) bytes = UUID.generate();
        else if (input instanceof UUID)
          (bytes = buffer_1.from(input.buffer)), (hexStr = input.__id);
        else if (ArrayBuffer.isView(input) && 16 === input.byteLength)
        ...
        return (
          ((_this = _super.call(this, bytes, 4) || this).__id = hexStr), _this
        );
      }
      return (
        ...
        Object.defineProperty(UUID.prototype, "id", {
          ...
          set: function (value) {
            (this.buffer = value),
              UUID.cacheHexString && (this.__id = bufferToUuidHexString(value));
          },
          enumerable: !1,
          configurable: !0,
        }),
        (UUID.prototype.toHexString = function (includeDashes) {
          if (
            (void 0 === includeDashes && (includeDashes = !0),
            UUID.cacheHexString && this.__id)
          )
            return this.__id;
          var uuidHexString = bufferToUuidHexString(this.id, includeDashes);
          return (
            UUID.cacheHexString && (this.__id = uuidHexString), uuidHexString
          );
        }),
        ...
        (UUID.createFromHexString = function (hexString) {
          return new UUID(uuidHexStringToBuffer(hexString));
        }),
        (UUID.prototype[Symbol.for("nodejs.util.inspect.custom")] =
          function () {
            return this.inspect();
          }),
    ...
    Code = (function () {
      ...
      return (
        ...
        (Code.prototype[Symbol.for("nodejs.util.inspect.custom")] =
          function () {
            return this.inspect();
          }),
        (Code.prototype.inspect = function () {
          ...
          return 'new Code("'
            .concat(String(codeJson.code), '"')
            .concat(
              codeJson.scope ? ", ".concat(JSON.stringify(codeJson.scope)) : "",
              ")"
            );
        }),
        Code
  ...
  function isDBRefLike(value) {
    return (
      ...
      (null == value.$db || "string" == typeof value.$db)
    );
  }
  ...
  var DBRef = (function () {
    function DBRef(collection, oid, db, fields) {
      ...
      2 === parts.length &&
        ((db = parts.shift()), (collection = parts.shift())),
    ...
    return (
      ...
      (DBRef.prototype.toJSON = function () {
        ...
        return null != this.db && (o.$db = this.db), o;
      }),
      (DBRef.prototype.toExtendedJSON = function (options) {
        options = options || {};
        var o = { $ref: this.collection, $id: this.oid };
        return options.legacy
          ? o
          : (this.db && (o.$db = this.db), (o = Object.assign(o, this.fields)));
      }),
      (DBRef.fromExtendedJSON = function (doc) {
        ...
        return (
          ...
          delete copy.$id,
          delete copy.$db,
          new DBRef(doc.$ref, doc.$id, doc.$db, copy)
        );
      }),
      ...
      (DBRef.prototype.inspect = function () {
        var oid =
          void 0 === this.oid || void 0 === this.oid.toString
            ? this.oid
            : this.oid.toString();
        return 'new DBRef("'
  ...
  var INT_CACHE = {},
    ...
    Long = (function () {
      function Long(low, high, unsigned) {
        if ((void 0 === low && (low = 0), !(this instanceof Long)))
      ...
      return (
        ...
        (Long.fromInt = function (value, unsigned) {
          ...
          return unsigned
            ? (cache = 0 <= (value >>>= 0) && value < 256) &&
              ...
              ? cachedObj
              : ((obj = Long.fromBits(value, (0 | value) < 0 ? -1 : 0, !0)),
                cache && (UINT_CACHE[value] = obj),
                obj)
            : (cache = -128 <= (value |= 0) && value < 128) &&
              (cachedObj = INT_CACHE[value])
            ? cachedObj
            : ((obj = Long.fromBits(value, value < 0 ? -1 : 0, !1)),
        ...
        (Long.fromNumber = function (value, unsigned) {
          ...
          if (unsigned) {
            ...
            if (value >= 0x10000000000000000) return Long.MAX_UNSIGNED_VALUE;
          } else {
            if (value <= -0x8000000000000000) return Long.MIN_VALUE;
            if (value + 1 >= 0x8000000000000000) return Long.MAX_VALUE;
          }
          return value < 0
            ? Long.fromNumber(-value, unsigned).neg()
            : Long.fromBits(
                value % 4294967296 | 0,
                (value / 4294967296) | 0,
                unsigned
        ...
        (Long.isLong = function (value) {
          return isObjectLike(value) && !0 === value.__isLong__;
        }),
        (Long.fromValue = function (val, unsigned) {
          return "number" == typeof val
            ? Long.fromNumber(val, unsigned)
            : "string" == typeof val
            ? Long.fromString(val, unsigned)
            : Long.fromBits(
                val.low,
                val.high,
        ...
        (Long.prototype.and = function (other) {
          return (
            Long.isLong(other) || (other = Long.fromValue(other)),
            Long.fromBits(
              this.low & other.low,
        ...
        (Long.prototype.divide = function (divisor) {
          if (
            (Long.isLong(divisor) || (divisor = Long.fromValue(divisor)),
            divisor.isZero())
          )
          ...
          if (this.unsigned) {
            ...
            if (this.eq(Long.MIN_VALUE))
              return divisor.eq(Long.ONE) || divisor.eq(Long.NEG_ONE)
                ? Long.MIN_VALUE
                : divisor.eq(Long.MIN_VALUE)
                ? Long.ONE
                : (approx = this.shr(1).div(divisor).shl(1)).eq(Long.ZERO)
                ? divisor.isNegative()
                  ? Long.ONE
                  : Long.NEG_ONE
          ...
          for (rem = this; rem.gte(divisor); ) {
            ...
            for (
              ...
              (approx -= delta),
                (approxRem = (approxRes = Long.fromNumber(
                  approx,
                  this.unsigned
                )).mul(divisor));
            approxRes.isZero() && (approxRes = Long.ONE),
        ...
        (Long.prototype.getNumBitsAbs = function () {
          ...
          var bit,
            val = 0 !== this.high ? this.high : this.low;
          for (bit = 31; bit > 0 && 0 == (val & (1 << bit)); bit--);
        ...
        (Long.prototype.modulo = function (divisor) {
          if (
            (Long.isLong(divisor) || (divisor = Long.fromValue(divisor)), wasm)
          ) {
        ...
        (Long.prototype.negate = function () {
          return !this.unsigned && this.eq(Long.MIN_VALUE)
            ? Long.MIN_VALUE
            : this.not().add(Long.ONE);
        }),
        ...
        (Long.prototype.shiftLeft = function (numBits) {
          return (
            Long.isLong(numBits) && (numBits = numBits.toInt()),
            0 == (numBits &= 63)
              ? this
              : numBits < 32
              ? Long.fromBits(
              ...
              : Long.fromBits(0, this.low << (numBits - 32), this.unsigned)
          );
        }),
        ...
        (Long.prototype.shiftRightUnsigned = function (numBits) {
          ...
          return 32 === numBits
            ? Long.fromBits(high, 0, this.unsigned)
            : Long.fromBits(high >>> (numBits - 32), 0, this.unsigned);
        }),
        ...
        (Long.prototype.toSigned = function () {
          return this.unsigned ? Long.fromBits(this.low, this.high, !1) : this;
        }),
        (Long.prototype.toString = function (radix) {
          if ((radix = radix || 10) < 2 || 36 < radix)
            throw RangeError("radix");
          ...
          for (
            var radixToPower = Long.fromNumber(
                Math.pow(radix, 6),
                this.unsigned
              ),
              rem = this,
        ...
        (Long.prototype.toUnsigned = function () {
          return this.unsigned ? this : Long.fromBits(this.low, this.high, !0);
        }),
        ...
        (Long.prototype[Symbol.for("nodejs.util.inspect.custom")] =
          function () {
            return this.inspect();
          }),
        ...
        (Long.TWO_PWR_24 = Long.fromInt(16777216)),
        (Long.MAX_UNSIGNED_VALUE = Long.fromBits(-1, -1, !0)),
        (Long.ZERO = Long.fromInt(0)),
        (Long.UZERO = Long.fromInt(0, !0)),
        (Long.ONE = Long.fromInt(1)),
        (Long.UONE = Long.fromInt(1, !0)),
        (Long.NEG_ONE = Long.fromInt(-1)),
        (Long.MAX_VALUE = Long.fromBits(-1, 2147483647, !1)),
        (Long.MIN_VALUE = Long.fromBits(0, -2147483648, !1)),
        Long
      );
    })();
  ...
  function divideu128(value) {
    var DIVISOR = Long.fromNumber(1e9),
      _rem = Long.fromNumber(0);
    if (!(value.parts[0] || value.parts[1] || value.parts[2] || value.parts[3]))
      return { quotient: value, rem: _rem };
    for (var i = 0; i <= 3; i++)
      (_rem = (_rem = _rem.shiftLeft(32)).add(new Long(value.parts[i], 0))),
  ...
  function invalidErr(string, message) {
    throw new BSONTypeError(
      '"'
        .concat(string, '" is not a valid Decimal128 string - ')
        .concat(message)
    );
  }
    ...
    return (
      (Decimal128.fromString = function (representation) {
        ...
        var stringMatch = representation.match(PARSE_STRING_REGEXP),
          infMatch = representation.match(PARSE_INF_REGEXP),
          nanMatch = representation.match(PARSE_NAN_REGEXP);
        if (
          (!stringMatch && !infMatch && !nanMatch) ||
          0 === representation.length
        )
          throw new BSONTypeError(
            representation + " not a valid Decimal128 string"
          );
        ...
        if (
          ...
          !isDigit(representation[index]) && "." !== representation[index])
        ) {
          if ("i" === representation[index] || "I" === representation[index])
            return new Decimal128(
              buffer_1.from(
                isNegative ? INF_NEGATIVE_BUFFER : INF_POSITIVE_BUFFER
              )
            );
          if ("N" === representation[index])
        ...
        for (
          ...
          "." !== representation[index]
            ? (nDigitsStored < 34 &&
                ("0" !== representation[index] || foundNonZero) &&
                (foundNonZero || (firstNonZero = nDigitsRead),
                (foundNonZero = !0),
                (digits[digitsInsert++] = parseInt(representation[index], 10)),
                (nDigitsStored += 1)),
              foundNonZero && (nDigits += 1),
              sawRadix && (radixPosition += 1),
              (nDigitsRead += 1),
              (index += 1))
            : (sawRadix &&
        ...
        if ("e" === representation[index] || "E" === representation[index]) {
          var match = representation.substr(++index).match(EXPONENT_REGEX);
          if (!match || !match[2])
            return new Decimal128(buffer_1.from(NAN_BUFFER));
          (exponent = parseInt(match[0], 10)), (index += match[0].length);
        }
        if (representation[index])
          return new Decimal128(buffer_1.from(NAN_BUFFER));
        if (((firstDigit = 0), nDigitsStored)) {
          if (
            ((lastDigit = nDigitsStored - 1),
            1 !== (significantDigits = nDigits))
          )
            for (; 0 === digits[firstNonZero + significantDigits - 1]; )
              significantDigits -= 1;
        } else
          (firstDigit = 0),
            (lastDigit = 0),
            ...
            (significantDigits = 0);
        for (
          exponent <= radixPosition && radixPosition - exponent > 16384
            ? (exponent = -6176)
            : (exponent -= radixPosition);
          exponent > 6111;

        ) {
          if ((lastDigit += 1) - firstDigit > 34) {
        ...
        for (; exponent < -6176 || nDigitsStored < nDigits; ) {
          if (0 === lastDigit && significantDigits < nDigitsStored) {
            (exponent = -6176), (significantDigits = 0);
            break;
          }
          if (
            (nDigitsStored < nDigits ? (nDigits -= 1) : (lastDigit -= 1),
            exponent < 6111)
          )
            exponent += 1;
          else {
        ...
        if (lastDigit - firstDigit + 1 < significantDigits) {
          ...
          sawRadix && ((firstNonZero += 1), (endOfString += 1)),
            isNegative && ((firstNonZero += 1), (endOfString += 1));
          var roundDigit = parseInt(
              representation[firstNonZero + lastDigit + 1],
              10
            ),
            roundBit = 0;
          if (roundDigit >= 5 && ((roundBit = 1), 5 === roundDigit))
            for (
          ...
          if (roundBit)
            for (var dIdx = lastDigit; dIdx >= 0; dIdx--)
              if (++digits[dIdx] > 9 && ((digits[dIdx] = 0), 0 === dIdx)) {
                if (!(exponent < 6111))
                  return new Decimal128(
                    buffer_1.from(
                      isNegative ? INF_NEGATIVE_BUFFER : INF_POSITIVE_BUFFER
        ...
        if (
          ...
          for (
            ...
            significandLow = (significandLow = significandLow.multiply(
              Long.fromNumber(10)
            )).add(Long.fromNumber(digits[dIdx]));
        } else {
          dIdx = firstDigit;
          for (
            ...
            significandHigh = (significandHigh = significandHigh.multiply(
              Long.fromNumber(10)
            )).add(Long.fromNumber(digits[dIdx]));
          for (
            significandLow = Long.fromNumber(digits[dIdx++]);
        ...
        var significand = (function multiply64x2(left, right) {
          if (!left && !right)
            return { high: Long.fromNumber(0), low: Long.fromNumber(0) };
          var leftHigh = left.shiftRightUnsigned(32),
            leftLow = new Long(left.getLowBits(), 0),
            rightHigh = right.shiftRightUnsigned(32),
            rightLow = new Long(right.getLowBits(), 0),
            productHigh = leftHigh.multiply(rightHigh),
            productMid = leftHigh.multiply(rightLow),
            productMid2 = leftLow.multiply(rightHigh),
            productLow = leftLow.multiply(rightLow);
          return (
            ...
            {
              high: (productHigh = productHigh.add(
                productMid.shiftRightUnsigned(32)
              )),
              low: (productLow = productMid
                .shiftLeft(32)
                .add(new Long(productLow.getLowBits(), 0))),
            }
          );
        })(significandHigh, Long.fromString("100000000000000000"));
        (significand.low = significand.low.add(significandLow)),
          (function lessThan(left, right) {
            var uhleft = left.high >>> 0,
              uhright = right.high >>> 0;
            return (
              uhleft < uhright ||
              (uhleft === uhright && left.low >>> 0 < right.low >>> 0)
            );
          })(significand.low, significandLow) &&
            (significand.high = significand.high.add(Long.fromNumber(1))),
          (biasedExponent = exponent + 6176);
        ...
        significand.high
          ...
          ? ((dec.high = dec.high.or(Long.fromNumber(3).shiftLeft(61))),
            (dec.high = dec.high.or(
              Long.fromNumber(biasedExponent).and(
                Long.fromNumber(16383).shiftLeft(47)
              )
            )),
            (dec.high = dec.high.or(
          ...
          : ((dec.high = dec.high.or(
              Long.fromNumber(16383 & biasedExponent).shiftLeft(49)
            )),
            (dec.high = dec.high.or(
              significand.high.and(Long.fromNumber(562949953421311))
            ))),
      ...
      (Decimal128.prototype.toString = function () {
        ...
        var combination = (high >> 26) & 31;
        if (combination >> 3 == 3) {
          if (30 === combination) return string.join("") + "Infinity";
          if (31 === combination) return "NaN";
          (biased_exponent = (high >> 15) & 16383),
            (significand_msb = 8 + ((high >> 14) & 1));
        } else
          (significand_msb = (high >> 14) & 7),
            (biased_exponent = (high >> 17) & 16383);
        var exponent = biased_exponent - 6176;
        if (
          ((significand128.parts[0] =
            (16383 & high) + ((15 & significand_msb) << 14)),
          (significand128.parts[1] = midh),
          (significand128.parts[2] = midl),
          (significand128.parts[3] = low),
          0 === significand128.parts[0] &&
            0 === significand128.parts[1] &&
            0 === significand128.parts[2] &&
            0 === significand128.parts[3])
        )
          is_zero = !0;
        else
          for (k = 3; k >= 0; k--) {
            var least_digits = 0,
              result = divideu128(significand128);
            if (
              ((significand128 = result.quotient),
              (least_digits = result.rem.low))
            )
              for (j = 8; j >= 0; j--)
                (significand[9 * k + j] = least_digits % 10),
                  (least_digits = Math.floor(least_digits / 10));
          }
        if (is_zero) (significand_digits = 1), (significand[index] = 0);
        else
          for (significand_digits = 36; !significand[index]; )
            (significand_digits -= 1), (index += 1);
        ...
        if (
          ...
          if (significand_digits > 34)
            return (
              ...
              exponent > 0
                ...
                : exponent < 0 && string.push("E".concat(exponent)),
              string.join("")
            );
          string.push("".concat(significand[index++])),
            (significand_digits -= 1) && string.push(".");
          ...
          for (string.push("."); radix_position++ < 0; ) string.push("0");
          for (
            i = 0;
  ...
  var Double = (function () {
    ...
    return (
      ...
      (Double.prototype.toExtendedJSON = function (options) {
        return options &&
          ...
          : (Number.isInteger(this.value)
              ? ($numberDouble = this.value.toFixed(1)).length >= 13 &&
      ...
      (Double.prototype[Symbol.for("nodejs.util.inspect.custom")] =
        function () {
          return this.inspect();
        }),
  ...
  var Int32 = (function () {
    ...
    return (
      ...
      (Int32.prototype.toExtendedJSON = function (options) {
        return options && (options.relaxed || options.legacy)
          ? this.value
  ...
  var MaxKey = (function () {
    ...
    return (
      ...
      (MaxKey.prototype[Symbol.for("nodejs.util.inspect.custom")] =
        function () {
          return this.inspect();
        }),
  ...
  var MinKey = (function () {
    ...
    return (
      ...
      (MinKey.prototype[Symbol.for("nodejs.util.inspect.custom")] =
        function () {
          return this.inspect();
        }),
  ...
  var checkForHexRegExp = new RegExp("^[0-9a-fA-F]{24}$"),
    ...
    ObjectId = (function () {
      function ObjectId(inputId) {
        ...
        var workingId;
        if ("object" == typeof inputId && inputId && "id" in inputId) {
          if ("string" != typeof inputId.id && !ArrayBuffer.isView(inputId.id))
            throw new BSONTypeError(
              "Argument passed in must have an id that is of type string or Buffer"
            );
          workingId =
            "toHexString" in inputId && "function" == typeof inputId.toHexString
              ? buffer_1.from(inputId.toHexString(), "hex")
              : inputId.id;
        } else workingId = inputId;
        if (null == workingId || "number" == typeof workingId)
          this[kId] = ObjectId.generate(
            "number" == typeof workingId ? workingId : void 0
          );
        else if (ArrayBuffer.isView(workingId) && 12 === workingId.byteLength)
          this[kId] =
            workingId instanceof buffer_1 ? workingId : ensureBuffer(workingId);
        else {
          if ("string" != typeof workingId)
            throw new BSONTypeError(
              "Argument passed in does not match the accepted types"
            );
          if (12 === workingId.length) {
            var bytes = buffer_1.from(workingId);
            if (12 !== bytes.byteLength)
              throw new BSONTypeError(
                "Argument passed in must be a string of 12 bytes"
              );
            this[kId] = bytes;
          } else {
            if (24 !== workingId.length || !checkForHexRegExp.test(workingId))
              throw new BSONTypeError(
        ...
        ObjectId.cacheHexString && (this.__id = this.id.toString("hex"));
      }
      return (
        Object.defineProperty(ObjectId.prototype, "id", {
          ...
          set: function (value) {
            (this[kId] = value),
              ObjectId.cacheHexString && (this.__id = value.toString("hex"));
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        (ObjectId.prototype.toHexString = function () {
          ...
          return (
            ObjectId.cacheHexString && !this.__id && (this.__id = hexString),
            hexString
          );
        }),
        ...
        (ObjectId.generate = function (time) {
          "number" != typeof time && (time = Math.floor(Date.now() / 1e3));
          var inc = ObjectId.getInc(),
            buffer = buffer_1.alloc(12);
          return (
            buffer.writeUInt32BE(time, 0),
            null === PROCESS_UNIQUE && (PROCESS_UNIQUE = randomBytes(5)),
        ...
        (ObjectId.prototype.toString = function (format) {
          return format ? this.id.toString(format) : this.toHexString();
        }),
        (ObjectId.prototype.toJSON = function () {
          return this.toHexString();
        }),
        (ObjectId.prototype.equals = function (otherId) {
          if (null == otherId) return !1;
          ...
          if (
            "object" == typeof otherId &&
            "toHexString" in otherId &&
            "function" == typeof otherId.toHexString
          ) {
            var otherIdString = otherId.toHexString(),
              thisIdString = this.toHexString().toLowerCase();
            return (
              "string" == typeof otherIdString &&
        ...
        (ObjectId.prototype.getTimestamp = function () {
          ...
          return timestamp.setTime(1e3 * Math.floor(time)), timestamp;
        }),
        ...
        (ObjectId.createFromTime = function (time) {
          ...
          return buffer.writeUInt32BE(time, 0), new ObjectId(buffer);
        }),
        (ObjectId.createFromHexString = function (hexString) {
          if (
            void 0 === hexString ||
            (null != hexString && 24 !== hexString.length)
          )
            throw new BSONTypeError(
        ...
        (ObjectId.index = Math.floor(16777215 * Math.random())),
        ObjectId
      );
    })();
  ...
  var BSONRegExp = (function () {
    function BSONRegExp(pattern, options) {
      ...
      if (
        ...
        (this.options = (function alphabetize(str) {
          return str.split("").sort().join("");
        })(null != options ? options : "")),
        -1 !== this.pattern.indexOf("\0"))
      )
        throw new BSONError(
    ...
    return (
      ...
      (BSONRegExp.fromExtendedJSON = function (doc) {
        if ("$regex" in doc) {
          if ("string" == typeof doc.$regex)
            return new BSONRegExp(
              doc.$regex,
              BSONRegExp.parseOptions(doc.$options)
            );
          if ("BSONRegExp" === doc.$regex._bsontype) return doc;
        }
        ...
        throw new BSONTypeError(
          "Unexpected BSONRegExp EJSON object form: ".concat(
            JSON.stringify(doc)
          )
        );
      }),
  ...
  var Timestamp = (function (_super) {
    function Timestamp(low, high) {
      var _this = this;
      return _this instanceof Timestamp
        ? ((_this = Long.isLong(low)
            ? _super.call(this, low.low, low.high, !0) || this
            : isObjectLike(low) && void 0 !== low.t && void 0 !== low.i
            ? _super.call(this, low.i, low.t, !0) || this
            : _super.call(this, low, high, !0) || this),
    ...
    return (
      ...
      (Timestamp.fromInt = function (value) {
        return new Timestamp(Long.fromInt(value, !0));
      }),
      (Timestamp.fromNumber = function (value) {
        return new Timestamp(Long.fromNumber(value, !0));
      }),
      (Timestamp.fromBits = function (lowBits, highBits) {
        return new Timestamp(lowBits, highBits);
      }),
      (Timestamp.fromString = function (str, optRadix) {
        return new Timestamp(Long.fromString(str, !0, optRadix));
      }),
  ...
  function deserializeValue(value, options) {
    if ((void 0 === options && (options = {}), "number" == typeof value)) {
    ...
    for (
      var keys = Object.keys(value).filter(function (k) {
          return k.startsWith("$") && null != value[k];
        }),
        i = 0;
      i < keys.length;
      i++
    ...
    if (null != value.$date) {
      ...
      return (
        options.legacy
          ? "number" == typeof d
            ? date.setTime(d)
            : "string" == typeof d && date.setTime(Date.parse(d))
          : "string" == typeof d
          ? date.setTime(Date.parse(d))
          : Long.isLong(d)
          ? date.setTime(d.toNumber())
          : "number" == typeof d && options.relaxed && date.setTime(d),
        date
      );
    }
    if (null != value.$code) {
      ...
      return (
        value.$scope && (copy.$scope = deserializeValue(value.$scope)),
        Code.fromExtendedJSON(value)
      );
    }
    if (isDBRefLike(value) || value.$dbPointer) {
      ...
      if (
        (dollarKeys.forEach(function (k) {
          -1 === ["$ref", "$id", "$db"].indexOf(k) && (valid_1 = !1);
        }),
        valid_1)
      )
  ...
  function getISOString(date) {
    ...
    return 0 !== date.getUTCMilliseconds() ? isoStr : isoStr.slice(0, -5) + "Z";
  }
  function serializeValue(value, options) {
    ...
    if (Array.isArray(value))
      return (function serializeArray(array, options) {
    ...
    if (!("number" != typeof value || (options.relaxed && isFinite(value)))) {
      if (Math.floor(value) === value) {
        var int64Range =
          value >= -0x8000000000000000 && value <= 0x8000000000000000;
        if (value >= -2147483648 && value <= 2147483647)
    ...
    return null != value && "object" == typeof value
      ? (function serializeDocument(doc, options) {
          ...
          if (isBSONType(doc)) {
            var outDoc = doc;
            if ("function" != typeof outDoc.toExtendedJSON) {
  ...
  var EJSON,
    BSON_TYPE_MAPPINGS = {
      ...
      Long: function (o) {
        return Long.fromBits(
          null != o.low ? o.low : o.low_,
          null != o.low ? o.high : o.high_,
          null != o.low ? o.unsigned : o.unsigned_
        );
      },
      MaxKey: function () {
        return new MaxKey();
  ...
  !(function (EJSON) {
    function parse(text, options) {
      ...
      return (
        "boolean" == typeof finalOptions.relaxed &&
          (finalOptions.strict = !finalOptions.relaxed),
        "boolean" == typeof finalOptions.strict &&
    ...
    function stringify(value, replacer, space, options) {
      null != space &&
        ...
        null == replacer ||
          ...
          ((options = replacer), (replacer = void 0), (space = 0));
      var doc = serializeValue(
        value,
        Object.assign({ relaxed: !0, legacy: !1 }, options, {
    ...
    (EJSON.parse = parse),
      ...
      (EJSON.serialize = function serialize(value, options) {
        return (options = options || {}), JSON.parse(stringify(value, options));
      }),
      (EJSON.deserialize = function deserialize(ejson, options) {
        return (options = options || {}), parse(JSON.stringify(ejson), options);
      });
  })(EJSON || (EJSON = {}));
    ...
    : (function () {
        ...
        (Map.prototype.clear = function () {
          ...
          (Map.prototype.delete = function (key) {
            ...
            return (
              null != value &&
              (delete this._values[key], this._keys.splice(value.i, 1), !0)
            );
          }),
          (Map.prototype.entries = function () {
            ...
            return {
              next: function () {
                ...
                return {
                  value: void 0 !== key ? [key, _this._values[key].v] : void 0,
                  done: void 0 === key,
                };
              },
            };
          ...
          (Map.prototype.values = function () {
            ...
            return {
              next: function () {
                var key = _this._keys[index++];
                return {
                  value: void 0 !== key ? _this._values[key].v : void 0,
                  done: void 0 === key,
                };
              },
            };
  ...
  Long.fromNumber(JS_INT_MAX), Long.fromNumber(JS_INT_MIN);
  new Set(["$db", "$ref", "$id", "$clusterTime"]);
  ...
  function parseUserAgent(ua) {
    var matchedRule = (function matchUserAgent(ua) {
      return (
        "" !== ua &&
  ...
  class DefaultNetworkTransport {
    ...
    async fetch(request) {
      const { timeoutMs: timeoutMs, url: url, ...rest } = request,
        { signal: signal, cancelTimeout: cancelTimeout } =
    ...
    createTimeoutSignal(timeoutMs) {
      ...
      return { signal: void 0, cancelTimeout: () => {} };
    }
  }
  ...
  "undefined" != typeof __DEV__ && __DEV__,
    ...
    (DefaultNetworkTransport.AbortController =
      safeGlobalThis.AbortController.bind(safeGlobalThis));
  const _hasatob = "function" == typeof atob,
    ...
    b64chs = Array.prototype.slice.call(
      "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
    ),
    b64tab = ((a) => {
      let tab = {};
      return a.forEach((c, i) => (tab[c] = i)), tab;
    })(b64chs),
    b64re =
    ...
    _fromUint8Array = _hasBuffer
      ...
      : (u8a) => {
          let strs = [];
          for (let i = 0, l = u8a.length; i < l; i += 4096)
            strs.push(_fromCC.apply(null, u8a.subarray(i, i + 4096)));
    ...
    cb_utob = (c) => {
      if (c.length < 2)
        return (cc = c.charCodeAt(0)) < 128
          ? c
          : cc < 2048
          ? _fromCC(192 | (cc >>> 6)) + _fromCC(128 | (63 & cc))
          : _fromCC(224 | ((cc >>> 12) & 15)) +
            _fromCC(128 | ((cc >>> 6) & 63)) +
            _fromCC(128 | (63 & cc));
      var cc =
        65536 + 1024 * (c.charCodeAt(0) - 55296) + (c.charCodeAt(1) - 56320);
      return (
        _fromCC(240 | ((cc >>> 18) & 7)) +
      ...
      switch (cccc.length) {
        case 4:
          var offset =
            ...
            65536;
          return (
            _fromCC(55296 + (offset >>> 10)) + _fromCC(56320 + (1023 & offset))
          );
        case 3:
          return _fromCC(
    ...
    atobPolyfill = (asc) => {
      if (((asc = asc.replace(/\s+/g, "")), !b64re.test(asc)))
        ...
        (u24 =
          ...
          (bin +=
            64 === r1
              ...
              : _fromCC((u24 >> 16) & 255, (u24 >> 8) & 255, 255 & u24));
      return bin;
    },
    _atob = _hasatob
    ...
    gBase64_encode = encode,
    gBase64_decode = decode,
    SERIALIZATION_OPTIONS = { relaxed: !1 };
  ...
  function bundle_dom_es_deserialize(obj) {
    return Array.isArray(obj)
      ? obj.map((doc) => EJSON.deserialize(doc))
      : EJSON.deserialize(obj);
  }
  var UserType, DataKey;
  !(function (UserType) {
    (UserType.Normal = "normal"), (UserType.Server = "server");
  })(UserType || (UserType = {})),
    (function (DataKey) {
      (DataKey.NAME = "name"),
        (DataKey.EMAIL = "email"),
  ...
  class UserProfile {
    constructor(response) {
      if (
        ...
        (this.identities = []),
        "object" == typeof response && null !== response)
      ) {
        const { type: type, identities: identities, data: data } = response;
        if ("string" != typeof type)
          throw new Error("Expected 'type' in the response body");
        if (((this.type = type), !Array.isArray(identities)))
          throw new Error("Expected 'identities' in the response body");
        if (
          ((this.identities = identities.map((identity) => {
            const { id: id, provider_type: providerType } = identity;
            return { id: id, providerType: providerType };
          })),
          ...
          throw new Error("Expected 'data' in the response body");
        {
          const mappedData = Object.fromEntries(
            Object.entries(data).map(([key, value]) =>
              key in DATA_MAPPING ? [DATA_MAPPING[key], value] : [key, value]
            )
          );
  ...
  class PrefixedStorage {
    constructor(storage, keyPart) {
      (this.storage = storage), (this.keyPart = keyPart);
    }
    get(key) {
  ...
  class UserStorage extends PrefixedStorage {
    ...
    get profile() {
      const value = this.get("profile");
      if (value) {
        const profile = new UserProfile();
        return Object.assign(profile, JSON.parse(value)), profile;
      }
    }
    set profile(value) {
      value
        ? this.set("profile", JSON.stringify(value))
        : this.remove("profile");
    }
    get providerType() {
      const value = this.get("providerType");
      if (value) return value;
    }
    set providerType(value) {
      value ? this.set("providerType", value) : this.remove("providerType");
    }
  }
  function removeKeysWithUndefinedValues(obj) {
    return Object.fromEntries(
      Object.entries(obj).filter((entry) => void 0 !== entry[1])
    );
  }
  function encodeQueryString(params, prefixed = !0) {
    const cleanedParams = removeKeysWithUndefinedValues(params);
    return (
      (prefixed && Object.keys(cleanedParams).length > 0 ? "?" : "") +
  ...
  function cleanArgsAndSerialize(args) {
    const cleaned = (function cleanArgs(args) {
      for (const arg of args)
        if ("object" == typeof arg && arg)
          for (const [key, value] of Object.entries(arg))
            void 0 === value && delete arg[key];
      return args;
    })(args);
    return cleaned.map((arg) =>
      "object" == typeof arg ? bundle_dom_es_serialize(arg) : arg
    );
  }
  class FunctionsFactory {
    ...
    static create(fetcher, config = {}) {
      ...
      return new Proxy(factory, {
        get(target, p, receiver) {
          if ("string" == typeof p && -1 === RESERVED_NAMES.indexOf(p))
            return target.callFunction.bind(target, p);
          {
            const prop = Reflect.get(target, p, receiver);
            return "function" == typeof prop ? prop.bind(target) : prop;
          }
        },
      });
    }
    async callFunction(name, ...args) {
      ...
      this.serviceName && (body.service = this.serviceName);
    ...
    callFunctionStreaming(name, ...args) {
      ...
      const appRoute = this.fetcher.appRoute,
        qs = encodeQueryString({
          baas_request: gBase64_encode(JSON.stringify(body)),
        });
  ...
  class EmailPasswordAuth {
    constructor(fetcher, providerName = "local-userpass") {
      (this.fetcher = fetcher), (this.providerName = providerName);
    }
  ...
  class WatchError extends Error {
    constructor({ message: message, code: code }) {
      super(message), (this.name = "WatchError"), (this.code = code);
    }
  }
  ...
  class WatchStream {
    ...
    feedBuffer(buffer) {
      this.assertState(WatchStreamState.NEED_DATA),
        (this._buffer += this._textDecoder.decode(buffer, { stream: !0 })),
    ...
    feedLine(line) {
      if (
        ...
        line.endsWith("\r") && (line = line.substr(0, line.length - 1)),
        0 === line.length)
      ) {
        if (0 === this._dataBuffer.length) return void (this._eventType = "");
      ...
      let value = -1 === colon ? "" : line.substr(colon + 1);
      value.startsWith(" ") && (value = value.substr(1)),
        "event" === field
    ...
    feedSse(sse) {
      ...
      if (-1 !== firstPercentIndex) {
        ...
        (buffer += sse.data.substr(start)), (sse.data = buffer);
      }
      if (sse.eventType && "message" !== sse.eventType) {
        if ("error" === sse.eventType) {
          ...
          try {
            const { error_code: errorCode, error: error } = EJSON.parse(
              sse.data
            );
            if ("string" != typeof errorCode) return;
            if ("string" != typeof error) return;
            this._error = new WatchError({ message: error, code: errorCode });
          } catch {
            return;
          }
        }
        ...
        try {
          ...
          if ("object" == typeof parsed)
            return (
              ...
              void (this._state = WatchStreamState.HAVE_EVENT)
            );
        } catch {}
        (this._state = WatchStreamState.HAVE_ERROR),
          (this._error = new WatchError({
    ...
    advanceBufferState() {
      for (
        this.assertState(WatchStreamState.NEED_DATA);
        this.state === WatchStreamState.NEED_DATA;

      ) {
        if (this._bufferOffset === this._buffer.length)
          return (this._buffer = ""), void (this._bufferOffset = 0);
        const nextNewlineIndex = this._buffer.indexOf("\n", this._bufferOffset);
        if (-1 === nextNewlineIndex)
          return void (
            0 !== this._bufferOffset &&
  ...
  class MongoDBCollection {
    ...
    watch({ ids: ids, filter: filter } = {}) {
      const iterator = this.functions
          ...
          .then((i) => i[Symbol.asyncIterator]()),
        stream = this.watchImpl(iterator),
        originalReturn = stream.return;
      return Object.assign(stream, {
        return(value) {
          return (
            iterator.then((i) => (i.return ? i.return(value) : void 0)),
            originalReturn.call(stream, value)
          );
        },
      });
    }
    async *watchImpl(iterator) {
      const watchStream = new WatchStream(),
        iterable = iterator.then((i) => ({ [Symbol.asyncIterator]: () => i }));
      for await (const chunk of await iterable)
        if (chunk) {
          for (
            watchStream.feedBuffer(chunk);
            watchStream.state == WatchStreamState.HAVE_EVENT;
  ...
  class User {
    constructor(parameters) {
      if (
        ...
        if (((this._profile = this.storage.profile), !providerType))
    ...
    set refreshToken(token) {
      (this._refreshToken = token), (this.storage.refreshToken = token);
    }
    get state() {
      return this.id in this.app.allUsers
        ? null === this.refreshToken
          ? UserState.LoggedOut
          : UserState.Active
        : UserState.Removed;
    }
    ...
    get customData() {
      if (this.accessToken) {
        return this.decodeAccessToken().userData;
      }
    ...
    get deviceId() {
      if (this.accessToken) {
        ...
        if (payload) {
          const deviceId = JSON.parse(gBase64_decode(payload)).baas_device_id;
          if (
            "string" == typeof deviceId &&
    ...
    async linkCredentials(credentials) {
      ...
      (this.accessToken = response.accessToken), await this.refreshProfile();
    }
    ...
    mongoClient(serviceName) {
      return (function createService(fetcher, serviceName = "mongo-db") {
    ...
    decodeAccessToken() {
      if (this.accessToken) {
        ...
        const encodedPayload = parts[1],
          decodedPayload = gBase64_decode(encodedPayload),
  ...
  class Credentials {
    ...
    static apiKey(key) {
      return new Credentials("api-key", "api-key", { key: key });
    }
    ...
    static jwt(token) {
      return new Credentials("custom-token", "custom-token", { token: token });
    }
    ...
    static derivePayload(payload) {
      ...
      if (1 === Object.keys(payload).length) {
        if ("authCode" in payload || "redirectUrl" in payload) return payload;
        if ("idToken" in payload) return { id_token: payload.idToken };
        throw new Error("Unexpected payload: " + JSON.stringify(payload));
      }
      throw new Error(
        "Expected only one property in payload, got " + JSON.stringify(payload)
      );
    }
  ...
  class AppStorage extends PrefixedStorage {
    ...
    getUserIds() {
      const userIdsString = this.get("userIds"),
        userIds = userIdsString ? JSON.parse(userIdsString) : [];
      if (Array.isArray(userIds)) return [...new Set(userIds)];
    ...
    setUserIds(userIds, mergeWithExisting) {
      if (mergeWithExisting) {
        ...
        for (const id of existingIds)
          -1 === userIds.indexOf(id) && userIds.push(id);
      }
      this.set("userIds", JSON.stringify(userIds));
    }
    removeUserId(userId) {
      const userIds = this.getUserIds().filter((id) => id !== userId);
      this.setUserIds(userIds, !1);
    }
    getDeviceId() {
  ...
  class OAuth2Helper {
    constructor(storage, openWindow = getEnvironment().openWindow) {
      (this.storage = storage.prefix("oauth2")), (this.openWindow = openWindow);
    }
    static parseRedirectLocation(queryString) {
      const params = (function decodeQueryString(str) {
    ...
    static handleRedirect(
      ...
      const result = OAuth2Helper.parseRedirectLocation(queryString),
        { state: state, error: error } = result;
      if ("string" != typeof state)
        throw error
          ? new Error(`Failed to handle OAuth 2.0 redirect: ${error}`)
          : new Error("Failed to handle OAuth 2.0 redirect.");
      {
        const oauth2Storage = storage.prefix("oauth2");
        OAuth2Helper.getStateStorage(oauth2Storage, state).set(
          "result",
      ...
      return new Promise((resolve, reject) => {
        ...
        const handleStorageUpdate = () => {
          ...
          if (result) {
            ...
            try {
              redirectWindow &&
                (clearInterval(windowClosedInterval), redirectWindow.close());
            } catch (err) {
        ...
        stateStorage.addListener(handleStorageUpdate),
          ...
          (windowClosedInterval = setInterval(() => {
            ...
            } else clearInterval(windowClosedInterval);
          }, 100));
      });
    }
    generateState() {
      return (function generateRandomString(length, alphabet) {
        let result = "";
  ...
  class Authenticator {
    ...
    async authenticate(credentials, linkingUser) {
      const deviceInformation = this.getDeviceInformation(),
        isLinking = "object" == typeof linkingUser;
      if (
        credentials.providerType.startsWith("oauth2") &&
        "string" == typeof credentials.payload.redirectUrl
      ) {
        const state = this.oauth2.generateState(),
          url = await this.getLogInUrl(credentials, isLinking, {
            state: state,
            redirect: credentials.payload.redirectUrl,
            providerRedirectHeader: !!isLinking || void 0,
            device: isLinking ? void 0 : deviceInformation.encode(),
          });
        if (isLinking) {
          const redirectUrl = (
          ...
          ).headers.get("x-baas-location");
          if (redirectUrl)
            return this.openWindowAndWaitForAuthResponse(redirectUrl, state);
          throw new Error("Missing x-baas-location header");
        }
      ...
      }
      {
        const logInUrl = await this.getLogInUrl(credentials, isLinking),
          response = await this.fetcher.fetchJSON({
            ...
            body: {
              ...credentials.payload,
              options: { device: deviceInformation.toJSON() },
            },
            tokenType: isLinking ? "access" : "none",
            user: linkingUser,
          }),
        ...
        if ("string" != typeof refreshToken && null !== refreshToken)
          throw new Error("Expected refresh token to be a string or null");
        if ("string" != typeof deviceId)
    ...
    async getLogInUrl(credentials, link = !1, extraQueryParams = {}) {
      const loginRoute = this.fetcher.appRoute
      ...
      return (await this.fetcher.locationUrl) + loginRoute.path + qs;
    }
  ...
  class MongoDBRealmError extends Error {
    constructor(method, url, statusCode, statusText, error, errorCode, link) {
      ...
      super(
        "string" == typeof error
          ? `Request failed (${method} ${url}): ${error} (${summary})`
          : `Request failed (${method} ${url}): (${summary})`
      ),
        (this.method = method),
        (this.url = url),
    ...
    static async fromRequestAndResponse(request, response) {
      ...
      const { url: url, method: method } = request,
        { status: status, statusText: statusText } = response;
      if (
        null === (_a = response.headers.get("content-type")) || void 0 === _a
          ? void 0
          : _a.startsWith("application/json")
      ) {
        const body = await response.json();
        if ("object" == typeof body && body) {
          const { error: error, error_code: errorCode, link: link } = body;
          return new MongoDBRealmError(
            method,
            url,
            status,
            statusText,
            "string" == typeof error ? error : void 0,
            "string" == typeof errorCode ? errorCode : void 0,
            "string" == typeof link ? link : void 0
          );
        }
      }
  ...
  class Fetcher {
    ...
    static buildBody(body) {
      if (body) {
        ...
        throw (
          (console.log("body is", body), new Error("Unexpected type of body"))
        );
      }
    }
    ...
    async fetch(request) {
      const {
        ...
        user: user = this.userContext.currentUser,
        ...restOfRequest
      } = request;
      if ("string" == typeof path && "string" == typeof url)
        throw new Error("Use of 'url' and 'path' mutually exclusive");
      if ("string" == typeof path) {
        const url = (await this.locationUrlContext.locationUrl) + path;
        return this.fetch({ ...request, path: void 0, url: url });
      }
      if ("string" == typeof url) {
        ...
        if (user && 401 === response.status && "access" === tokenType)
          return (
            await user.refreshAccessToken(),
            this.fetch({ ...request, user: user })
          );
        throw (
          (user &&
            401 === response.status &&
          ...
          await MongoDBRealmError.fromRequestAndResponse(request, response))
        );
      }
    ...
    async fetchJSON(request) {
      ...
      if (
        ...
        return bundle_dom_es_deserialize(await response.json());
      }
      if (null === contentType) return null;
      throw new Error(`Expected JSON response, got "${contentType}"`);
    }
    async fetchStream(request) {
      const { body: body } = await this.fetch({
        ...request,
        headers: { Accept: "text/event-stream", ...request.headers },
      });
      return (function asyncIteratorFromResponseBody(body) {
        if ("object" != typeof body || null === body)
          throw new Error("Expected a non-null object");
        if (Symbol.asyncIterator in body) return body;
          ...
          return {
            [Symbol.asyncIterator]() {
              ...
              return {
                ...
                async return() {
                  return await reader.cancel(), { done: !0, value: null };
                },
              };
            },
          };
  ...
  class DeviceInformation {
    constructor({ appId: appId, appVersion: appVersion, deviceId: deviceId }) {
    ...
    encode() {
      ...
      return gBase64_encode(JSON.stringify(obj));
    }
    toJSON() {
  ...
  class App {
    constructor(idOrConfiguration) {
      ...
      const configuration =
        "string" == typeof idOrConfiguration
          ? { id: idOrConfiguration }
          : idOrConfiguration;
      if (
        "object" != typeof configuration ||
        "string" != typeof configuration.id
      )
        throw new Error("Missing an Atlas App Services app-id");
      (this.id = configuration.id),
        (this.baseUrl = configuration.baseUrl || "https://realm.mongodb.com"),
        configuration.skipLocationRequest &&
          (this._locationUrl = Promise.resolve(this.baseUrl)),
        (this.localApp = configuration.app);
      const {
        storage: storage,
        transport: transport = new DefaultNetworkTransport(),
      } = configuration;
    ...
    static getApp(id) {
      if (id in App.appCache) return App.appCache[id];
      {
        const instance = new App(id);
        return (App.appCache[id] = instance), instance;
      }
    }
    switchUser(nextUser) {
    ...
    async logIn(credentials, fetchProfile = !0) {
      const response = await this.authenticator.authenticate(credentials),
        user = this.createOrUpdateUser(response, credentials.providerType);
      this.switchUser(user),
        fetchProfile && (await user.refreshProfile()),
    ...
    get currentUser() {
      ...
      return 0 === activeUsers.length ? null : activeUsers[0];
    }
    get allUsers() {
    ...
    get locationUrl() {
      if (!this._locationUrl) {
        ...
        this._locationUrl = this.fetcher
          ...
          .catch((err) => {
            throw ((this._locationUrl = null), err);
          });
      }
    ...
    get deviceInformation() {
      const deviceIdStr = this.storage.getDeviceId(),
        deviceId =
          "string" == typeof deviceIdStr &&
          "000000000000000000000000" !== deviceIdStr
    ...
    createOrUpdateUser(response, providerType) {
        ...
        );
      {
        ...
        return this.users.unshift(user), user;
      }
    }
    hydrate() {
      const userIds = this.storage.getUserIds();
      this.users = userIds.map((id) => new User({ app: this, id: id }));
    }
  }
  (App.appCache = {}), (App.Credentials = Credentials);
  const check$1 = function (it) {
      return it && it.Math == Math && it;
    },
    safeGlobalThis$1 =
      check$1("object" == typeof globalThis && globalThis) ||
      check$1("object" == typeof window && window) ||
      check$1("object" == typeof self && self) ||
      check$1(
        "object" == typeof __webpack_require__.g && __webpack_require__.g
      ) ||
      (function () {
      ...
      Function("return this")();
  "undefined" != typeof __DEV__ && __DEV__;
  const browser = (function detect(userAgent) {
      return userAgent
    ...
    DefaultStorage =
      "localStorage" in safeGlobalThis$1
        ? class LocalStorage {
            constructor() {
            ...
            clear(prefix) {
              ...
              for (let i = 0; i < this.global.localStorage.length; i++) {
                ...
                !key || (prefix && !key.startsWith(prefix)) || keys.push(key);
              }
              for (const key of keys) this.global.localStorage.removeItem(key);
            }
            addListener(listener) {
        ...
        : class MemoryStorage {
            ...
            set(key, value) {
              (this.storage[key] = value), this.fireListeners();
            }
            remove(key) {
              delete this.storage[key], this.fireListeners();
            }
            prefix(keyPart) {
              return new PrefixedStorage(this, keyPart);
            }
            clear(prefix) {
              for (const key of Object.keys(this.storage))
                (prefix && !key.startsWith(prefix)) || delete this.storage[key];
              this.fireListeners();
            }
            addListener(listener) {
  ...
  const environment$1 = {
    ...
    openWindow: function openWindow(url) {
      return "function" == typeof safeGlobalThis$1.open
        ? safeGlobalThis$1.open(url)
        : (console.log(`Please open ${url}`), null);
    },
    platform: (null == browser ? void 0 : browser.name) || "web",
    platformVersion: (null == browser ? void 0 : browser.version) || "0.0.0",
  ...
  var startUp = (function () {
    var _ref = (function _asyncToGenerator(fn) {
      ...
      _regeneratorRuntime().mark(function _callee() {
        var app, credentials, mongo, db;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          for (;;)
            switch ((_context.prev = _context.next)) {
              case 0:
                return (
                  (app = new App({ id: "nexmap-izeal" })),
              ...
              case 5:
                return (
                  ...
                  (db = mongo.db("nexAction").collection("skills")),
                  _context.abrupt("return", db)
                );
              case 8:
              case "end":
      ...
      (BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
        ...
        if ("function" == typeof substitution) {
          ...
          return _super[Symbol.replace].call(this, str, function () {
            var args = arguments;
            return (
              "object" != occultist_typeof(args[args.length - 1]) &&
  ...
  var actions = [
    {
      id: "warp",
      fullName: "Warp",
      firstPerson: _wrapRegExp(
        /^You reach out and clench a fist before (.+?), who screams and doubles over in agony as \w+ skin suddenly bubbles with gangrenous growths\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: _wrapRegExp(
        /^(\w+?) reaches out and clenches a fist before (.+?), who screams and doubles over in agony as \w+ skin suddenly bubbles with gangrenous growths\.$/,
        { user: 1, target: 2 }
      ),
    ...
    },
    {
      ...
      secondPerson: !1,
      thirdPerson: _wrapRegExp(
        /^(\w+?) raises a tarot over \w+ head, parallel to the ground. Upon releasing it, it instantly expands and moves downward until \w+ entire body has been passed through it\.$/,
        { user: 1 }
      ),
    ...
    },
    {
      ...
      fullName: "Harry",
      firstPerson: _wrapRegExp(
        /^Raising your hands in the air, you summon horrific visions to torment (.+?)\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Harry tick",
      firstPerson: _wrapRegExp(
        /^(.+?) is tormented by horrific visions from the Plane of Chaos\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Chaosgate",
      firstPerson: _wrapRegExp(
        /^You cup your hands together and fling them outwards, sending a spiral of shimmering portals into (.+?)'s body\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Stagnate",
      firstPerson: _wrapRegExp(
        /^You wave one arm at (.+?), causing a small time rift to form around her\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
  ...
  function dragon_wrapRegExp() {
    dragon_wrapRegExp = function _wrapRegExp(re, groups) {
      return new BabelRegExp(re, void 0, groups);
    };
    var _super = RegExp.prototype,
      _groups = new WeakMap();
    function BabelRegExp(re, flags, groups) {
      ...
      return (
        _groups.set(_this, groups || _groups.get(re)),
        dragon_setPrototypeOf(_this, BabelRegExp.prototype)
      );
    }
    function buildGroups(result, re) {
      var g = _groups.get(re);
    ...
    return (
      dragon_inherits(BabelRegExp, RegExp),
      (BabelRegExp.prototype.exec = function (str) {
        var result = _super.exec.call(this, str);
        if (result) {
          result.groups = buildGroups(result, this);
      ...
      (BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
        ...
        if ("function" == typeof substitution) {
          ...
          return _super[Symbol.replace].call(this, str, function () {
            var args = arguments;
            return (
              "object" != dragon_typeof(args[args.length - 1]) &&
                (args = [].slice.call(args)).push(buildGroups(args, _this)),
              substitution.apply(this, args)
            );
          });
      ...
      dragon_wrapRegExp.apply(this, arguments)
    );
  }
  function dragon_inherits(subClass, superClass) {
    if ("function" != typeof superClass && null !== superClass)
      throw new TypeError("Super expression must either be null or a function");
    (subClass.prototype = Object.create(superClass && superClass.prototype, {
      constructor: { value: subClass, writable: !0, configurable: !0 },
      ...
      Object.defineProperty(subClass, "prototype", { writable: !1 }),
      superClass && dragon_setPrototypeOf(subClass, superClass);
  }
  function dragon_setPrototypeOf(o, p) {
    return (
      (dragon_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            return (o.__proto__ = p), o;
          }),
      dragon_setPrototypeOf(o, p)
    );
  }
  var dragon_actions = [
    {
      ...
      firstPerson: dragon_wrapRegExp(
        /^You rip into (.+?) with your massive, deadly claws\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: dragon_wrapRegExp(
        /^(\w+?) rips into (.+?) with \w+ massive, deadly claws\.$/,
        { user: 1, target: 2 }
      ),
      profession: ["dragon"],
      skill: "dragoncraft",
    ...
    },
    {
      ...
      firstPerson: dragon_wrapRegExp(
        /^Drawing from the well of your puissance, you invoke a dramatic chant in the dragon tongue\. Your voice resonates with each word, culminating in a wave of magical energy that you bend to your will and thrust towards (.+), bombarding \w+ with the ancient power\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: dragon_wrapRegExp(
        /^A resonant vibration emanates from (\w+) as \w+ invokes a rumbling, sonorous chant in the dragon tongue\. As the sound increases, (.+?) jerks violently, \w+ body wracked by an unseen force\.$/,
        { user: 1, target: 2 }
      ),
      profession: ["dragon"],
      skill: "dragoncraft",
    ...
    },
    {
      ...
      fullName: "Glaciate",
      firstPerson: dragon_wrapRegExp(
        /^You breathe a column of icy air at (.+?)'s head, stunning \w+\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Frostrive",
      firstPerson: dragon_wrapRegExp(
        /^(.+?)'s translucent shield cracks and fades away as you breathe an icy blast at it\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Override",
      firstPerson: dragon_wrapRegExp(
        /^You barrel into (.+?) and knock \w+ to the ground before stomping over \w+ prone form\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Tailsmash",
      firstPerson: dragon_wrapRegExp(
        /^You flick your tail at (.+?), dismissively brushing aside the paltry shield protecting \w+\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Ague",
      firstPerson: dragon_wrapRegExp(
        /^You let loose a steady stream of cold air around (.+?), who begins to shiver uncontrollably\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      firstPerson: dragon_wrapRegExp(
        /^You form small chunks of ice in your enormous maw, then spit them at (.+?) in a barrage\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Frostwave",
      firstPerson: dragon_wrapRegExp(
        /^You breathe a wave of icy air at (.+?)\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      secondPerson: !1,
      thirdPerson: dragon_wrapRegExp(
        /^(\w+) opens \w+ gigantic maw and spews acid on (.+?)\. \w+ is too clumsy to dodge and is covered in the corrosive slime\.$/,
        { user: 1, target: 2 }
      ),
      profession: ["dragon"],
      skill: "attainment",
    ...
    },
    {
      ...
      firstPerson: dragon_wrapRegExp(
        /^You breathe a long torrent of flame at (.+?), igniting \w+ skin\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      secondPerson: !1,
      thirdPerson: dragon_wrapRegExp(
        /^(.+?) is wracked with pain as the flames of dragonbreath wreathe over \w+ skin\.$/,
        { target: 1 }
      ),
      profession: ["dragon"],
      skill: "attainment",
    ...
    },
    {
      ...
      fullName: "Scorch",
      firstPerson: dragon_wrapRegExp(
        /^You blacken (.+?)'s flesh with a quick blast of flame, slowing \w+ healing process\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Overwhelm",
      firstPerson: dragon_wrapRegExp(
        /^You charge quickly at (.+?), throwing your mighty form into \w+ and sending \w+ staggering back\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      firstPerson: dragon_wrapRegExp(
        /^You slap your tail on the ground while growling at (.+?), forcing \w+ to recklessly attack\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Flamebath",
      firstPerson: dragon_wrapRegExp(
        /^You blast (.+?) with a bath of flame, but \w+ is able to avoid the brunt of the blast\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
    ...
    },
    {
      ...
      fullName: "Melt",
      firstPerson: dragon_wrapRegExp(
        /^You breathe a white\x2Dhot blast of flame at (.+?) and burn away \w+ translucent shield\.$/,
        { target: 1 }
      ),
      secondPerson: !1,
      thirdPerson: !1,
  ...
  function depthswalker_typeof(obj) {
    return (
      (depthswalker_typeof =
        "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
          ? function (obj) {
      ...
      depthswalker_typeof(obj)
    );
  }
  function depthswalker_wrapRegExp() {
    depthswalker_wrapRegExp = function _wrapRegExp(re, groups) {
      return new BabelRegExp(re, void 0, groups);
    };
    var _super = RegExp.prototype,
      _groups = new WeakMap();
    function BabelRegExp(re, flags, groups) {
      ...
      return (
        _groups.set(_this, groups || _groups.get(re)),
        depthswalker_setPrototypeOf(_this, BabelRegExp.prototype)
      );
    }
    function buildGroups(result, re) {
      var g = _groups.get(re);
    ...
    return (
      depthswalker_inherits(BabelRegExp, RegExp),
      (BabelRegExp.prototype.exec = function (str) {
        var result = _super.exec.call(this, str);
        if (result) {
          result.groups = buildGroups(result, this);
      ...
      (BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
        ...
        if ("function" == typeof substitution) {
          ...
          return _super[Symbol.replace].call(this, str, function () {
            var args = arguments;
            return (
              "object" != depthswalker_typeof(args[args.length - 1]) &&
                (args = [].slice.call(args)).push(buildGroups(args, _this)),
              substitution.apply(this, args)
            );
          });
      ...
      depthswalker_wrapRegExp.apply(this, arguments)
    );
  }
  function depthswalker_inherits(subClass, superClass) {
    if ("function" != typeof superClass && null !== superClass)
      throw new TypeError("Super expression must either be null or a function");
    (subClass.prototype = Object.create(superClass && superClass.prototype, {
      constructor: { value: subClass, writable: !0, configurable: !0 },
      ...
      Object.defineProperty(subClass, "prototype", { writable: !1 }),
      superClass && depthswalker_setPrototypeOf(subClass, superClass);
  }
  function depthswalker_setPrototypeOf(o, p) {
    return (
      (depthswalker_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            return (o.__proto__ = p), o;
          }),
      depthswalker_setPrototypeOf(o, p)
    );
  }
  var depthswalker_actions = [
    {
      id: "reap",
      fullName: "Reap",
      firstPerson: !1,
      secondPerson: !1,
      thirdPerson: depthswalker_wrapRegExp(
        /^(.+?) lashes out with a swift, reaping blow at (.+?)\.$/,
        { user: 1, target: 2 }
      ),
    ...
    },
    {
      ...
      secondPerson: !1,
      thirdPerson: depthswalker_wrapRegExp(
        /^As the weapon strikes (.+?), he seems greatly diminished\.$/,
        { target: 1 }
      ),
      profession: ["depthswalker"],
      skill: "shadowmancy",
  ...
  function psion_wrapRegExp() {
    psion_wrapRegExp = function _wrapRegExp(re, groups) {
      return new BabelRegExp(re, void 0, groups);
    };
    var _super = RegExp.prototype,
      _groups = new WeakMap();
    function BabelRegExp(re, flags, groups) {
      ...
      return (
        _groups.set(_this, groups || _groups.get(re)),
        psion_setPrototypeOf(_this, BabelRegExp.prototype)
      );
    }
    function buildGroups(result, re) {
      var g = _groups.get(re);
    ...
    return (
      psion_inherits(BabelRegExp, RegExp),
      (BabelRegExp.prototype.exec = function (str) {
        var result = _super.exec.call(this, str);
        if (result) {
          result.groups = buildGroups(result, this);
      ...
      (BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
        ...
        if ("function" == typeof substitution) {
          ...
          return _super[Symbol.replace].call(this, str, function () {
            var args = arguments;
            return (
              "object" != psion_typeof(args[args.length - 1]) &&
                (args = [].slice.call(args)).push(buildGroups(args, _this)),
              substitution.apply(this, args)
            );
          });
      ...
      psion_wrapRegExp.apply(this, arguments)
    );
  }
  function psion_inherits(subClass, superClass) {
    if ("function" != typeof superClass && null !== superClass)
      throw new TypeError("Super expression must either be null or a function");
    (subClass.prototype = Object.create(superClass && superClass.prototype, {
      constructor: { value: subClass, writable: !0, configurable: !0 },
      ...
      Object.defineProperty(subClass, "prototype", { writable: !1 }),
      superClass && psion_setPrototypeOf(subClass, superClass);
  }
  function psion_setPrototypeOf(o, p) {
    return (
      (psion_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            return (o.__proto__ = p), o;
          }),
      psion_setPrototypeOf(o, p)
    );
  }
  var psion_actions = [
    {
      ...
      firstPerson: !1,
      secondPerson: !1,
      thirdPerson: psion_wrapRegExp(
        /^(.+?) brings a translucent mace around in a savage overhand strike, smashing it into the head of (.+?)\.$/,
        { user: 1, target: 2 }
      ),
      profession: ["psion"],
      skill: "weaving",
    ...
    },
    {
      ...
      secondPerson: !1,
      thirdPerson: psion_wrapRegExp(
        /^Almost too swift to perceive, (.+?) lashes out with a translucent dagger, tracing a bloody line across the throat of (.+?)\.$/,
        { user: 1, target: 2 }
      ),
      profession: ["psion"],
      skill: "weaving",
      balance: "balance",
      multiLine: 1,
      tags: ["asthma", "bleeding"],
      length: 2.2,
    },
  ];
  function nur_typeof(obj) {
    return (
      (nur_typeof =
        "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
          ? function (obj) {
  ...
  function nur_wrapRegExp() {
    nur_wrapRegExp = function _wrapRegExp(re, groups) {
      return new BabelRegExp(re, void 0, groups);
    };
    var _super = RegExp.prototype,
      _groups = new WeakMap();
    function BabelRegExp(re, flags, groups) {
      ...
      return (
        _groups.set(_this, groups || _groups.get(re)),
        nur_setPrototypeOf(_this, BabelRegExp.prototype)
      );
    }
    function buildGroups(result, re) {
      var g = _groups.get(re);
    ...
    return (
      nur_inherits(BabelRegExp, RegExp),
      (BabelRegExp.prototype.exec = function (str) {
        var result = _super.exec.call(this, str);
        if (result) {
          result.groups = buildGroups(result, this);
      ...
      (BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
        ...
        if ("function" == typeof substitution) {
          ...
          return _super[Symbol.replace].call(this, str, function () {
            var args = arguments;
            return (
              "object" != nur_typeof(args[args.length - 1]) &&
                (args = [].slice.call(args)).push(buildGroups(args, _this)),
              substitution.apply(this, args)
            );
          });
      ...
      nur_wrapRegExp.apply(this, arguments)
    );
  }
  function nur_inherits(subClass, superClass) {
    if ("function" != typeof superClass && null !== superClass)
      throw new TypeError("Super expression must either be null or a function");
    (subClass.prototype = Object.create(superClass && superClass.prototype, {
      constructor: { value: subClass, writable: !0, configurable: !0 },
      ...
      Object.defineProperty(subClass, "prototype", { writable: !1 }),
      superClass && nur_setPrototypeOf(subClass, superClass);
  }
  function nur_setPrototypeOf(o, p) {
    return (
      (nur_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            return (o.__proto__ = p), o;
          }),
      nur_setPrototypeOf(o, p)
    );
  }
  var nur_npcs = [
    {
    ...
    },
    {
      ...
      thirdPerson: nur_wrapRegExp(
        /^The form of a vanguard angel shifts abruptly to an incorporeal mist which passes through (.+?)'s convulsing body before regaining physicality on the other side\.$/,
        { target: 1 }
      ),
  ...
  var nexSkills_npcs = [].concat(
      ...
      _toConsumableArray([
        ...
        {
          user: "a hooded Tsol'dasi villager",
          crowdMapId: [263],
          areaName: "Istarion",
          firstPerson:
        ...
        },
        {
          ...
          thirdPerson: !1,
          tags: ["damage", "prone", "brokenleftarm"],
          length: 4,
        },
        {
    ...
    nexSkills_actions = [].concat(
      _toConsumableArray(actions),
      _toConsumableArray(dragon_actions),
      _toConsumableArray(depthswalker_actions),
      _toConsumableArray(actions),
      _toConsumableArray(psion_actions)
    ),
    checkNpcs = function checkNpcs(text) {
      var result = !1,
        action = !1,
        areaNpcs = nexSkills_npcs.filter(function (e) {
          return e.areaId.includes(GMCP.Location.areaid);
        });
      if (0 === areaNpcs.length) return !1;
      for (var i = 0; i < areaNpcs.length; i++) {
        if (
          ((action = areaNpcs[i]), (result = text.match(action.firstPerson)))
        ) {
          var _result$groups;
          (action.target = "self"),
            null !== (_result$groups = result.groups) &&
              void 0 !== _result$groups &&
              _result$groups.user &&
              (action.user = result.groups.user);
          break;
        }
        if ((result = text.match(action.thirdPerson))) {
          action.target = result.groups.target;
          break;
        }
      }
      return (
        result && eventStream.raiseEvent("nexSkillNpcMatch", action),
        result || !1
      );
    },
    nexSkills = {
      actions: nexSkills_actions,
      npcs: nexSkills_npcs,
      checkSkills: function checkSkills(text) {
        for (
          var result = !1, action = !1, i = 0;
          i < nexSkills_actions.length;
          i++
        ) {
          if (
            ((action = nexSkills_actions[i]),
            GMCP.Char.Status.class.toLowerCase().includes(action.profession) &&
              (result = text.match(action.firstPerson)))
          ) {
            (action.user = "self"), (action.target = result.groups.target);
            break;
          }
          if ((result = text.match(action.secondPerson))) {
            (action.user = result.groups.user), (action.target = "self");
            break;
          }
          if ((result = text.match(action.thirdPerson))) {
            (action.user = result.groups.user),
        ...
        return (
          result && eventStream.raiseEvent("nexSkillMatch", action),
          result || checkNpcs(text)
        );
      },
      checkNpcs: checkNpcs,
      startUp: startUp,
