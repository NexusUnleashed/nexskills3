(() => {
  "use strict";
  const attainment_depthswalker = Object.values({
      lash: {
        id: "lash",
        fullName: "Lash",
        firstPerson:
    ...
    attainment_dragon = Object.values({
      glaciate: {
        id: "glaciate",
        fullName: "Glaciate",
        firstPerson:
    ...
    attainment_occultist = Object.values({
      harry: {
        id: "harry",
        fullName: "Harry",
        firstPerson:
    ...
    attainment_runewarden = Object.values({
      collide: {
        id: "collide",
        fullName: "Collide",
        firstPerson:
    ...
    attainment_sylvan = Object.values({
      thornpierce: {
        id: "thornpierce",
      ...
      dominationCroneCommand: {
        ...
        reaction(action) {
          (action.info = action.args.groups.limb),
            action.affs.push(
              "broken".concat(action.args.groups.limb.replace(" ", ""))
            );
        },
      },
    ...
    skills_domination = Object.values(domination),
    dragoncraft = {
      gut: {
        id: "gut",
        fullName: "Gut",
    ...
    skills_dragoncraft = Object.values(dragoncraft),
    skills_ignition = Object.values({
      flamewhip: {
        id: "flamewhip",
        fullName: "Flamewhip",
        firstPerson:
    ...
    skills_memorium = Object.values(memorium),
    occultism = {
      warp: {
        id: "warp",
        fullName: "Warp",
      ...
      instill: {
        ...
        secondPerson:
          /^(?<user>\w+) makes a quick, sharp gesture toward you\.$/,
      ...
      compelDiscord: {
        ...
        reaction(skill) {
          ...
          (compelId = compelId.includes("potential") ? "potential" : compelId),
            (skill.id = "compel".concat(compelId)),
            (skill.fullName = "Compel ".concat(
              compelId.charAt(0).toUpperCase() + compelId.slice(1)
            ));
        },
      },
    },
    skills_occultism = Object.values(occultism),
    skills_oppression = Object.values({
      exploit: {
        id: "exploit",
    ...
    skills_propagation = Object.values({
      thornrend: {
        id: "thornrend",
        fullName: "Thornrend",
        firstPerson:
    ...
    skills_shadowmancy = Object.values({
      reap: {
        id: "reap",
        fullName: "Reap",
        firstPerson:
    ...
    skills_spirituality = Object.values({
      chasten: {
        id: "chasten",
        fullName: "Chasten",
        firstPerson: !1,
    ...
    skills_subterfuge = Object.values({
      garrote: {
        id: "garrote",
        fullName: "Garrote",
        firstPerson: !1,
    ...
    skills_weaponmastery = Object.values({
      battlefuryFocus: {
        id: "battlefuryFocus",
    ...
    skills_weatherweaving = Object.values({
      stormhammer: {
        id: "stormhammer",
    ...
    general_curing = Object.values({
      ...
      smoke: {
        ...
        secondPerson: !1,
        thirdPerson:
          /^(?<user>\w+) takes a long drag off \w+ (?<target>.+?)\.$/,
        profession: ["general"],
        skill: "",
        balance: "smoke",
        multiLine: 0,
      ...
      sip: {
        ...
        secondPerson: !1,
        thirdPerson:
          /^(?<user>\w+) takes a drink from (?:a|an) (?<target>.+?)\.$/,
        profession: ["general"],
        skill: "",
        balance: "sip",
        multiLine: 0,
      ...
      focus: {
        ...
        secondPerson: !1,
        thirdPerson:
          /^A look of extreme focus crosses the face of (?<user>\w+)\.$/,
        profession: ["general"],
        skill: "",
        balance: "focus",
        multiLine: 0,
  ...
  npcs.forEach((npc) => {
    npc.areaId.forEach((areaId) => {
      npcsMap.has(areaId) || npcsMap.set(areaId, []),
  ...
  const actions = [
      ...
      ...skills_tekura,
      ...skills_venom,
      ...skills_weaponmastery,
      ...skills_weatherweaving,
      ...skills_weaving,
      ...skills_zeal,
      ...general_curing,
      ...general_general,
    ...
    evaluateText = (action, text, matchType, defaultUser, defaultTarget) => {
      if (!action[matchType]) return !1;
      const result = text.match(action[matchType]);
      if (!result) return !1;
      ((result, action, matchType, defaultUser, defaultTarget) => {
        if (result) {
          const { groups } = result;
          return (
            (action.match = matchType),
            (action.user =
              (null == groups ? void 0 : groups.user) || defaultUser),
            (action.target =
              (null == groups ? void 0 : groups.target) || defaultTarget),
            (action.info = (null == groups ? void 0 : groups.info) || !1),
            (action.args = result),
            !0
          );
        }
      })(result, action, "secondPerson", "", "self");
    },
    finalizeCheck = (action) => (
      action.reaction && action.reaction(action),
      eventStream.raiseEvent("nexSkillMatch", action),
      eventStream.raiseEvent("nexSkillMatch".concat(action.id), action),
      action
    ),
    checkNpcs = (text) => {
      const areaId = GMCP.Location.areaid,
        areaNpcs = npcsMap.get(areaId) || [];
      let result = !1,
        action = !1;
      ...
      for (let i = 0; i < areaNpcs.length; i++) {
        if (
          ((action = areaNpcs[i]),
          (result = !!action.firstPerson && text.match(action.firstPerson)),
          result)
        ) {
          var _result$groups;
          (action.target = "self"),
        ...
        if (
          ((result = !!action.thirdPerson && text.match(action.thirdPerson)),
          result)
        ) {
        ...
        for (let i = 0; i < actions.length; i++) {
          if (
            ...
            (action.profession.includes(profession) ||
              ...
              evaluateText(false, action, text, 0, 0))
          )
            return (
              "you" === action.target.toLowerCase() && (action.target = "self"),
              finalizeCheck(false)
            );
          if (evaluateText(false, action, text, 0, 0))
