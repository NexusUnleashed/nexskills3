...
!(function () {
      ...
      (BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
        ...
        if ("function" == typeof substitution) {
          ...
          return _super[Symbol.replace].call(this, str, function () {
            var args = arguments;
            return (
              "object" != actions_typeof(args[args.length - 1]) &&
  ...
  var actions_actions = [
      ...
      },
      {
        id: "frostwave",
        fullName: "Frostwave",
        firstPerson: _wrapRegExp(/^You breathe a wave of icy air at (.+?)\.$/, {
          target: 1,
        }),
        secondPerson: !1,
        thirdPerson: !1,
    ...
    checkNpcs = function checkNpcs(text) {
      for (var result = !1, action = !1, i = 0; i < npcs.length; i++) {
        if (((action = npcs[i]), (result = text.match(action.firstPerson)))) {
          var _result$groups;
          (action.target = "self"),
      ...
      return (
        result && eventStream.raiseEvent("nexSkillMatch", action), result || !1
      );
    },
    nexSkills = {
      ...
      checkSkills: function checkSkills(text) {
        for (
          ...
          i < actions_actions.length;
          i++
        ) {
          if (
            ((action = actions_actions[i]),
            GMCP.Char.Status.class.toLowerCase().indexOf(action.profession) >
              -1 && (result = text.match(action.firstPerson)))
          ) {
